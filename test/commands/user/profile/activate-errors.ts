...
describe("Profile Activate Command Errors", function () {
  describe("EmptyIndexError", function () {
    ...
    it("should have correct id", function () {
      ...
      expect(err.errorId).to.equal("profileActivate-emptyIndex");
  ...
  describe("IndexNotANumberError", function () {
    ...
    it("should have correct id", function () {
      ...
      expect(err.errorId).to.equal("profileActivate-indexNotANumber");
  ...
  describe("IndexOutOfRangeError", function () {
    ...
    it("should have correct id", function () {
      ...
      expect(err.errorId).to.equal("profileActivate-indexOutOfRange");
  ...
  describe("NoProfileRecordError", function () {
    ...
    it("should have correct id", function () {
      ...
      expect(err.errorId).to.equal("profileActivate-noProfileRecord");
  ...
  describe("EmptyProfileError", function () {
    ...
    it("should have correct id", function () {
      ...
      expect(err.errorId).to.equal("profileActivate-emptyProfile");
